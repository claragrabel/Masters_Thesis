...
load("C:/Users/tester/Desktop/MADOBIS/TFM/TFM_Workspace/Normal_With_Llano.RData")
...
2154 up-regulated and 2420 genes down regulated. These would be DEGs accounting for the regional variation in the transcriptome in optimal water conditions, when there is no pond drying stress. 
...
2474 genes up-regulated and 2736 genes down-regulated. These genes are differentially expressed in the distinct regions in low water conditions, meaning genes that respond differently regarding pond drying stress. 
...
```
247 up-regulated and 302 down-regulated. These are genes that are differentially expressed when the southern region populations are exposed to low water level compared to high water level.
...
#DOUBT
# The summary function already takes out the NAs

# If will extract the DEGs independently using the filter function, we get the same amount of DEGs.
...
# 549 is the total number of degs if we sum up those up and down regulated before
```
...
These are genes that are differentially expressed in the central spain populations when submitted to pond drying stress.
