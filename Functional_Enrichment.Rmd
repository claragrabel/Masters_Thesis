...
I got the same result, 329 supposedly from the metadata failed.
...
test_ora_proc$result %>%
  ...
  dplyr::count(query, sort=TRUE)
```
The difference in the number of DEGs is only 6 more or less, except for the lS_lC that is reduced by 14.
