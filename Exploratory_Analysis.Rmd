...
We have to manually calculate this distances first, and then use those distances to inform the heatmap.
...
With this heatmap, we would conclude something analogous to the PCA: there is greater dissimilarity between regions than between water level. 
