...
# res_water_pop is the comparison obtained for waterLevel_low_vs_high when using as design waterLevel * population
...
Populations from the south seem to be closer/more similar between them than populations in the center? At least they have less DEGs between them.
...
Specific combinations of population and water level, indicating interaction effects—where the expression change due to water level differs significantly among populations.
...
We will reduce the txi object to only one population in each case and see the results this way.
