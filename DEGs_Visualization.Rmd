...
```{r}
xtr_background<-lapply(all_degs_test, FUN=extract_xtr)
...
We will use g:profiler. 
The associated R package gprofiler2 is an API, and the actual analysis will be performed on the g:Profiler server. This version is continuously updated, to match the updates Because of this, it is important to tell gprofiler which version of Ensembl you would like to use
