...
sig_degs_set <- list(central = sig_degs$central, south = sig_degs$south)

venn.plot <- venn.diagram(
  x = sig_degs,
  category.names = c("Central", "South"),
  filename = NULL,
  output = TRUE,
  lwd = 2,
  col = c("darkblue", "darkblue"),
  fill = c(alpha("dodgerblue4", 0.5), alpha("blue4", 0.5)),
  cex = 1.5,
  fontface = "bold",
  fontfamily = "sans",
  cat.cex = 1.5,
  ...
  cat.fontfamily = "sans",
  scaled = FALSE  # Ensures circles are of equal size
)
