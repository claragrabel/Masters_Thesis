...
ggsave("central_volcanoplot.jpeg", width = 8, height = 5 , dpi = 600)
```
...
genes_to_label <- c("mmp11.1", "ass1", "sec14l3", "stard8", "klf9", "hsp90")
...
gg_south
ggsave("south_volcanoplot.jpeg", width = 8, height = 5 , dpi = 600)
